...
public class AuctionComponentProvider extends BaseComponentProvider {
  ...
  public List<ComponentResource> getGlobalComponentResources() {
    ...
    globalResources
        .add(createStaticResource("web/org.openbravo.auction/js/auctions-view.js", false));
    globalResources
        .add(createStaticResource("web/org.openbravo.auction/js/auction-info-view.js", false));
    globalResources.add(
        createStaticResource("web/org.openbravo.auction/js/published-auction-info-view.js", false));
    globalResources.add(createStaticResource(
        "web/org.openbravo.auction/js/published-auction-buyers-view.js", false));
    globalResources
        .add(createStaticResource("web/org.openbravo.auction/js/auctions-winners.js", false));
    globalResources
